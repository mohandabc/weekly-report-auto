      ...
      <header className={`flex flex-col h-72 bg-light-mode dark:bg-dark-mode min-h-screen bg-no-repeat bg-cover bg-center bg-fixed header`}>
        <div className="flex sticky top-40 justify-center items-center">
          <div className="pt-24 pb-24">
            <h1 className="my-4 mx-9 text-4xl font-bold leading-tight text-slate-200">
              <span className="text-5xl text-white-700">Welcome {user.name}!</span>
            </h1>
            <p className="leading-normal text-2xl mb-8 text-slate-200">
              <span className="text-3xl font-semibold">OilPort:</span> Your Gateway to Oil Field Data and Analytics
              <br />
              <span className="text-3xl font-semibold">Unlock</span> the power of data-driven insights with our reporting app.
