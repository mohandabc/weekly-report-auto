      ...
      <header className={`flex flex-col h-72 bg-light-mode dark:bg-dark-mode min-h-screen bg-no-repeat bg-cover bg-center bg-fixed header`}>
        <div className="flex sticky top-40 justify-center items-center">
          <div className="py-12 px-48 bg-gradient-to-b from-sky-900 to-transparent rounded-lg shadow-lg mx-9">
            <h1 className="my-4 text-3xl font-bold leading-tight text-white animate__animated animate__fadeInUp">
              <span className="text-3xl text-sky-400">
                Welcome {user.name}!
              </span>
            </h1>
            <p className="leading-normal text-xl mb-8 text-white px-16 animate__animated animate__fadeInUp">
              <span className="text-xl font-semibold">OilPort:</span> Your Gateway to Oil Field Data and Analytics
              <br />
              <span className="text-xl font-semibold">Unlock</span> the power of data-driven insights with our reporting app.
